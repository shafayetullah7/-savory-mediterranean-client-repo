    ...
    return (
        <div className='w-[330px] h-[460px] border border-[#FFB100] p-3 rounded-xl flex flex-col'>
            ...
            <div className='mt-3 relative h-full'>
                ...
                <p className='text-gray-500 mt-2 leading-4 text-justify text-xs h-24 border p-1 rounded-md overflow-x-scroll shadow-lg'><span className='font-bold text-black'>Cooking method :</span> {recipe.cookingMethod} years</p>
